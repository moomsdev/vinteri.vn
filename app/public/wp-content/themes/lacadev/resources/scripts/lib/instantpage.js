...
if ( 'instantIntensity' in document.body.dataset ) {
	...
	if ( t.substr( 0, 'mousedown'.length ) == 'mousedown' ) {
		( u = ! 0 ), t == 'mousedown-only' && ( f = ! 0 );
	} else if ( t.substr( 0, 'viewport'.length ) == 'viewport' ) {
			...
			document.addEventListener(
				...
				( t ) => {
					...
					n.addEventListener(
						'click',
						( t ) => {
							t.detail != 1337 && t.preventDefault();
						},
